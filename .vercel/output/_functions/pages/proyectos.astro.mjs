...
import 'clsx';
/* empty css                                     */
import { c as getImage, $ as $$Image } from '../chunks/_astro_assets_B1Ytf8IM.mjs';
import { g as getCollection } from '../chunks/_astro_content_Ch_dagx4.mjs';
...
}, "D:/ProyectosGenerales/ProyectosPersonales/portafolio-huayapa/src/components/otros/categoryLenguageBox.astro", void 0);
...
const $$ProyectCard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { id, name, image = "imageDefault.jpg", descript, linkPage, categorys, linkGitHub } = dataCard;
...
}, "D:/ProyectosGenerales/ProyectosPersonales/portafolio-huayapa/src/components/proyectos/proyectList.astro", void 0);
...
const $$MisProyectos = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="misProyectos" data-astro-cid-bjhoidrb> ${renderComponent($$result, "ProyectList", $$ProyectList, { "nameList": "Proyectos Destacados", "MinlimitCards": "0", "MaxlimitCards": "3", "data-astro-cid-bjhoidrb": true })} <!-- <div>
	...
	</div> --> ${renderComponent($$result, "ProyectList", $$ProyectList, { "nameList": "Todos los proyectos", "MinlimitCards": "3", "MaxlimitCards": "6", "data-astro-cid-bjhoidrb": true })} </section> `;
}, "D:/ProyectosGenerales/ProyectosPersonales/portafolio-huayapa/src/components/proyectos/misProyectos.astro", void 0);
...
}, "D:/ProyectosGenerales/ProyectosPersonales/portafolio-huayapa/src/pages/proyectos.astro", void 0);

const $$file = "D:/ProyectosGenerales/ProyectosPersonales/portafolio-huayapa/src/pages/proyectos.astro";
const $$url = "/proyectos";
