...
const $$Modal = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<dialog${addAttribute("modal-message", "class")}${addAttribute(isSuccess, "data-isSuccess")} data-astro-cid-2zd6jnmd> <article data-astro-cid-2zd6jnmd> <div class="section-img" data-astro-cid-2zd6jnmd> <canvas id="dotlottie-canvas" style="width: 5rem; height:5rem;" data-astro-cid-2zd6jnmd></canvas> </div> <div class="section-info" data-astro-cid-2zd6jnmd> <h3 data-astro-cid-2zd6jnmd>${title}</h3> <p data-astro-cid-2zd6jnmd>${descript}</p> </div> </article> <button onclick="this.parentElement.close()" data-astro-cid-2zd6jnmd>X</button> </dialog> ${renderScript($$result, "D:/Dev/ProyectosGenerales/ProyectosPersonales/portafolio-huayapa/src/components/otros/modal.astro?astro&type=script&index=0&lang.ts")} `;
}, "D:/Dev/ProyectosGenerales/ProyectosPersonales/portafolio-huayapa/src/components/otros/modal.astro", void 0);
...
}, "D:/Dev/ProyectosGenerales/ProyectosPersonales/portafolio-huayapa/src/components/contacto/contactoForm.astro", void 0);
...
}, "D:/Dev/ProyectosGenerales/ProyectosPersonales/portafolio-huayapa/src/components/contacto/contactoContentInfo.astro", void 0);
...
}, "D:/Dev/ProyectosGenerales/ProyectosPersonales/portafolio-huayapa/src/components/contacto/contactoList.astro", void 0);
...
}, "D:/Dev/ProyectosGenerales/ProyectosPersonales/portafolio-huayapa/src/pages/contactame.astro", void 0);

const $$file = "D:/Dev/ProyectosGenerales/ProyectosPersonales/portafolio-huayapa/src/pages/contactame.astro";
